...
if exist %~p0\..\liquibase-core-4.18.0.jar SET LIQUIBASE_HOME="%~p0\.."
...
"%JAVA_PATH%" -cp "%LIQUIBASE_HOME%\lib\h2-1.4.200.jar;%LIQUIBASE_HOME%\liquibase-core-4.18.0.jar" liquibase.example.StartH2Main
